...
<div class="page-slider margin-bottom-35">
	...
	<div id="layerslider"
		...
		<div class="ls-slide ls-slide1"
			...
			<img src="/jpact3/assets/frontend/pages/img/layerslider/slide1/bg.jpg"
		...
		<div class="ls-slide ls-slide2"
			...
			<img src="/jpact3/assets/frontend/pages/img/layerslider/slide2/bg.jpg"
				class="ls-bg" alt="Slide background">
		...
		<div class="ls-slide ls-slide3"
			...
			<img src="/jpact3/assets/frontend/pages/img/layerslider/slide3/bg.jpg"
				class="ls-bg" alt="Slide background">
		...
		<div class="ls-slide ls-slide4"
			...
			<img src="/jpact3/assets/frontend/pages/img/layerslider/slide5/bg.jpg"
				class="ls-bg" alt="Slide background">
